...
def main():
   ...
   # h1 = http.client.HTTPConnection(url)
    ...
    print("carbon cost: " + str(ans["carbon_cost"]))
    print("carbon comparison: " + str(ans["carbon_comparison"]))
    print("electricity cost: " + str(ans["electricity_cost"]))
    print("cost: " + str(ans["monetary_cost"]))
